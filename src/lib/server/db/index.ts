 ...
 */
export function createDatabaseClient(env: { DB?: D1Database; DATABASE_URL?: string }): Database {
	if (env.DB) {
		...
		throw new Error('No database configuration found. Please set DATABASE_URL or provide D1 binding.');
	}
}
